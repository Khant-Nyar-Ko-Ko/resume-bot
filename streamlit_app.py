...
st.set_page_config(page_icon="👨‍💼", layout="wide",
                   page_title="Khant Nyar Ko Ko's Resume Bot")


st.subheader("👨‍💼📊📈📁 Khant Nyar Ko Ko's Interactive Resume")
st.write(
    "Welcome to Khant Nyar Ko Ko's personal chat bot to answer John's previous experiences and his skillsets. Ask away what you want to know!"
)
